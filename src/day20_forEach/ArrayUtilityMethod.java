...
public class ArrayUtilityMethod {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(scores));//since it returns String you can assign it to s tring
        String result=Arrays.toString(scores);
        System.out.println(result);
        System.out.println("==================================================");
        //equals () method return boolean
        int[] a1={1,2,3,4,5};//here to be equal elements and order should be the same
        int[] a2={1,2,3,4,5};
